local config = {
    ...
    storage = 30030, -- Storage para verificar se o jogador já usou
    urnaItemID = 30030, -- Substitua pelo ID da urna
    newVocationID = 20, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1455, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
