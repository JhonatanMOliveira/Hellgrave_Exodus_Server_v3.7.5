local config = {
    ...
    storage = 29967, -- Storage para verificar se o jogador já usou
    urnaItemID = 29967, -- Substitua pelo ID da urna
    newVocationID = 18, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1446, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
