local config = {
    ...
    urnaItemID = 29946,
    newVocationID = 14,
    newOutfitLookType = 1443,
    originalVocationID = 11,
    originalOutfitLookType = 1440,

    efeitoativado = 28,
    efeitodesativado = 28,

    vozativar = "Cavaleiro Zoologico: Voz que vira o Cavaleiro",
    vozdesativar = "Cavaleiro Zoologico: Voz que volta o Cavaleiro ao normal",

    mensagemAtivar = "Itens adicionados aos slots e alteracoes ativadas.",
    mensagemDesativar = "Itens removidos dos slots e alteracoes desativadas."
}
