local config = {
    ...
    storage = 29946, -- Storage para verificar se o jogador já usou
    urnaItemID = 29946, -- Substitua pelo ID da urna
    newVocationID = 14, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1443, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
