local config = {
    ...
    storage = 30009, -- Storage para verificar se o jogador já usou
    urnaItemID = 30009, -- Substitua pelo ID da urna
    newVocationID = 27, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1452, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
