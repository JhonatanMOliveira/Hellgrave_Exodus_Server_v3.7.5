local config = {
    ...
    storage = 30016, -- Storage para verificar se o jogador já usou
    urnaItemID = 30016, -- Substitua pelo ID da urna
    newVocationID = 21, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1453, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
