local config = {
    ...
    storage = 30037, -- Storage para verificar se o jogador já usou
    urnaItemID = 30037, -- Substitua pelo ID da urna
    newVocationID = 22, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1456, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
