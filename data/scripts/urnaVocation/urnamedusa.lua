local config = {
    ...
    storage = 29960, -- Storage para verificar se o jogador já usou
    urnaItemID = 29960, -- Substitua pelo ID da urna
    newVocationID = 17, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1445, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
