local config = {
    ...
    storage = 30002, -- Storage para verificar se o jogador já usou
    urnaItemID = 30002, -- Substitua pelo ID da urna
    newVocationID = 25, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1451, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
