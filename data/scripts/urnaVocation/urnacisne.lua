local config = {
    ...
    storage = 29988, -- Storage para verificar se o jogador já usou
    urnaItemID = 29988, -- Substitua pelo ID da urna
    newVocationID = 24, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1449, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
