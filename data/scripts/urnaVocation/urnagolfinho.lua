local config = {
    ...
    storage = 29953, -- Storage para verificar se o jogador já usou
    urnaItemID = 29953, -- Substitua pelo ID da urna
    newVocationID = 15, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1444, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
