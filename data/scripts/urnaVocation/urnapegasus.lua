local config = {
    ...
    storage = 29981, -- Storage para verificar se o jogador já usou
    urnaItemID = 29981, -- Substitua pelo ID da urna
    newVocationID = 26, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1448, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
