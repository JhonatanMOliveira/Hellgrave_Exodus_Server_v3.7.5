local config = {
    ...
    storage = 29995, -- Storage para verificar se o jogador já usou
    urnaItemID = 29995, -- Substitua pelo ID da urna
    newVocationID = 23, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1450, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
