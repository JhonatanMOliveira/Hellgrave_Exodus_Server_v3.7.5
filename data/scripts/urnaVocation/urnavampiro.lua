local config = {
    ...
    storage = 29974, -- Storage para verificar se o jogador já usou
    urnaItemID = 29974, -- Substitua pelo ID da urna
    newVocationID = 16, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1447, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
