local config = {
    ...
    storage = 30023, -- Storage para verificar se o jogador já usou
    urnaItemID = 30023, -- Substitua pelo ID da urna
    newVocationID = 19, -- Substitua pelo ID da nova vocação (no caso, 16)
    newOutfitLookType = 1454, -- Substitua pelo lookType do novo outfit (completo com 3 addons)
