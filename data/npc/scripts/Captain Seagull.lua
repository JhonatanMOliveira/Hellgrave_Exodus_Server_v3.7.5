...
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = "WWhere do you want to go? To {Mordragor}, {Dolwatha}, {Falanaar}, {Freewind}, {Arkedon} or {Death Valley}?"})
