...
-- Troca a cada 30 minutos. Comando manual: /spawnitem
-- ============================================================
...
local group1 = {
	...
	subgroups = {
		...
		-- Micro-grupo 5 (1 sera sorteado) aleatorio
		{
...
local function spawnGroup(group)
	...
	print("[SpawnMinerio] Grupo [" .. itemNames .. "]: " .. spawned .. " minerios spawnados.")
end
